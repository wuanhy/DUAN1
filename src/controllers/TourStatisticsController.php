...
class TourStatisticsController{
    public function thongKe(){
        ...
        $list_tour = TourStatisticsModel::  getByStatus($type);
        include PATH_VIEW . 'admin/list_thong_ke.php';
    }
    public function addLich(){
        $ds_tour = TourStatisticsModel::getAllTours();
        include PATH_VIEW . 'admin/add.php';
    }
    public function storeLich(){
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $tour= TourStatisticsModel::getTourById($tour_id);
            ...
            // Luu vao CSDL
            TourStatisticsModel::insert($tour_id, $ngay_khoihanh, $ngay_ketthuc, $so_cho);
            // Chuyen huong ve danh sach
            header("Location: " . BASE_URL . 'admin-thongKe');
            exit();
        }
    }
}
