            ...
            <div class="col-10" style="padding-top: 100px;">
                <div class="tour-list-container">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <a href="<?= BASE_URL . '?act=admin-addtour' ?>" class="btn btn-sm btn-success">
                            <i class="fas fa-plus-circle"></i> Thêm Tour Mới
                        </a>
                    </div>
                    <div class="mb-4 d-flex justify-content-between">
                        <form class="d-flex" action="<?= BASE_URL . '?act=admin-tourlist'?>" method="GET" style="width: 100%;">
                            ...
                            <tbody>
                                <?php foreach ($tb_danhmuc as $key => $dm): ?>
                                    <tr>
                                        ...
                                        <td><?= $dm['mo_ta_tour'] ?></td>
                                        <td>
                                            <a href="<?= BASE_URL . '?act=admin-edittour&tour_id=' . $dm['tour_id'] ?>" class="btn btn-warning">Sửa</a>
                                            <a href="<?= BASE_URL . '?act=admin-delete-tour&tour_id=' . $dm['tour_id'] ?>" class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa không')">Xóa</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
