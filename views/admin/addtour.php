                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="p-4 rounded shadow-sm" style="background-color: #F8E8E8;">
                                ...
                                <form action="?act=admin-addtour" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="noi_xuat_phat" name="noi_xuat_phat" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="diem_den" class="form-label">Điểm Đến Chính</label>
                                                    <input type="text" class="form-control" id="diem_den" name="diem_den" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="ma_tour" class="form-label">Mã Tour (*)</label>
                                                <input type="text" class="form-control" id="ma_tour" name="ma_tour" required >
                                            </div>

                                            <div class="mb-3">
                                                <label for="mo_ta_tour" class="form-label">Mô tả Tour / Tóm tắt Lịch trình</label>
                                                <textarea class="form-control" id="mo_ta_tour" name="mo_ta_tour" rows="3"></textarea>
                                            </div>
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="so_cho_toi_da" name="so_cho_toi_da" min="1">
                                                </div>

                                                <div class="col-md-3 mb-3">
                                                    <label for="gia_co_ban" class="form-label">Giá Tour</label>
                                                    <input type="number" class="form-control" id="gia_co_ban" name="gia_co_ban" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
