                            ...
                            <tbody>
                                <?php foreach ($listdata as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= BASE_URL . 'admin-update-blog&id=' . $value['id'] ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i>Sửa</a>
                                            <a href="<?= BASE_URL . 'admin-delete-blog&id=' . $value['id'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Ban co muon xoa khong')"><i class="bi bi-trash-fill"></i>Xóa</a>
                                        </td>
                                    </tr> <?php endforeach ?>
                            </tbody>
                        </table>
