                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 fw-bold text-primary mb-1">
                            <i class="bi bi-trophy-fill me-2"></i> Dashboard Analytics</h1>
                        <p class="text-muted mb-0" style="font-size: 0.9rem;">Tổng quan chi tiết và hoạt động kinh doanh và hiệu suất hệ thống</p>
                    </div>
                    <button class="btn btn-sm btn-outline-primary" style="white-space: nowrap;"><i class="bi bi-calendar me-1"></i> Tất cả Dịch vụ</button>
                </div>
            </div>
            <div class=" p-4 mx-3 card analytics-card mb-4 border-0">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-muted mb-3"><i class="bi bi-table me-2"></i> Thống kê đặt chỗ</h5>
                    ...
                    <div class="alert-orange mt-4 text-center">
                        <i class="bi bi-exclamation-triangle-fill me-2"></i> Cần xử lý: 0 đơn đặt chỗ cần xác nhận ngay.
                    </div>
