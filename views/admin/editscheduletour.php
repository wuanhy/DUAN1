                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10">
                            <div class="p-4 rounded shadow-sm" style="background-color: #F8E8E8;">
                                <form action="<?= BASE_URL . '?act=admin-edit-schedule&ltr_id=' . $data['ltr_id'] ?>" method="POST" class="needs-validation" novalidate>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="danhmuc" name="danhmuc" required>
                                            ...
                                            <?php foreach ($listTour as $value) : ?>
                                                <option value="<?= $value['tour_id'] ?>" <?= $data['tour_id']===$value['tour_id'] ? 'selected' : '' ?>>
                                                    <?= $value['ten_tour'] ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ngay_thu" name="ngay_thu" required value="<?= $data['ngay_thu'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="tieu_de" class="form-label fw-bold">Tiêu đề</label>
                                        <input type="text" class="form-control" id="tieu_de" name="tieu_de" required value="<?= $data['tieu_de'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="noi_dung" class="form-label fw-bold">Nội dung</label>
                                        <textarea type="text" class="form-control" id="noi_dung" name="noi_dung" required><?= $data['noi_dung'] ?></textarea>
                                    </div>
                                    <div class="d-flex justify-content-end gap-2">
                                        <button type="submit" name="btn-edit-schedule" class="btn btn-success">
                                            Cập nhật Lịch trình
                                        </button>
                                        <a href="<?= BASE_URL . '?act=admin-scheduletour' ?>" class="btn btn-secondary">
                                            Quay lại
                                        </a>
                                    </div>
                                </form>
