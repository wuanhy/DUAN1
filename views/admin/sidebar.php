                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse list-unstyled ps-3" id="collapseTour" data-bs-parent="#sidebarMenu">
                            <a class="nav-link text-muted py-2" href="<?= BASE_URL . '?act=admin-tourlist' ?>">Danh sách Tour</a>
                            <a class="nav-link text-muted py-2" href="<?= BASE_URL . '?act=admin-addtour' ?>">Thêm Tour mới</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse list-unstyled ps-3" id="collapseSchedule" data-bs-parent="#sidebarMenu">
                            <a class="nav-link text-muted py-2" href="<?= BASE_URL . '?act=admin-scheduletour' ?>">Danh sách Lịch trình các chuyến Tuor</a>
                            <a class="nav-link text-muted py-2" href="<?= BASE_URL . '?act=admin-addscheduletour' ?>">Thêm Lịch trình các chuyến Tuor</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse list-unstyled ps-3" id="collapseBooking" data-bs-parent="#sidebarMenu">
                            <a class="nav-link text-muted py-2" href="<?= BASE_URL . '?act=admin-bookinglist' ?>">Danh sách Đặt chỗ</a>
                            <a class="nav-link text-muted py-2" href="<?= BASE_URL . '?act=admin-refundmanage' ?>">Quản lý hoàn tiền</a>
                        </div>
                    </li>
