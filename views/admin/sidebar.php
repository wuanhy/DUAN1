...
<head>
  ...
  <title>Document</title><title>Elite Travel - Trang chủ</title>
...
<body>
  <header>
   ...
   <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-white sidebar collapse" style="position: fixed; top: 60px; bottom: 0; left: 0; z-index: 100; padding: 0; overflow-y: auto;">
    <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark d-flex align-items-center" href="#collapseTour" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseTour">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark d-flex align-items-center" href="#collapseSchedule" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseSchedule">
    ...
    <li class="nav-item">
        <a class="nav-link text-dark d-flex align-items-center" href="#collapseBooking" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseBooking">
        ...
        <div class="collapse list-unstyled ps-3" id="collapseBooking" data-bs-parent="#sidebarMenu">
            ...
            <li class="nav-item">
                    <a class="nav-link text-dark d-flex align-items-center" href="#collapseHotel" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseHotel">
            ...
            <li class="nav-item">
                        <a class="nav-link text-dark d-flex align-items-center" href="#collapseBlog" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseBlog">
                            <i class="bi bi-journal-text me-2"></i> Quản Lý Blog <i class="bi bi-chevron-down ms-auto sidebar-icon-toggle"></i>
                        </a>
            ...
            <li class="nav-item">
                <a class="nav-link text-dark d-flex align-items-center" href="#collapseTransport" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseTransport">
           ...
           <li class="nav-item">
            <a class="nav-link text-dark d-flex align-items-center" href="#collapseAccount" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseAccount">
