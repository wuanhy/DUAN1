...
<head>
    ...
    <title>Giới thiệu - Tour Travel</title>
            ...
            <div class="accordion accordion-flush" id="introductionAccordion">
                ...
                <div class="accordion-item shadow-sm mb-3 border rounded-3">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed fw-bold fs-5 text-primary py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            Giới thiệu về Tour Travel
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#introductionAccordion">
                        <div class="accordion-body bg-light">
                            <h3 class="h5 fw-bold text-dark border-bottom pb-2">1. Chúng tôi là Tour Travel</h3>
                            <p class="text-secondary mt-2">
                                Tour Travel là sản phẩm chính thức của Công ty TNHH Du lịch và Dịch vụ Tour Travel...
                            </p>
                                    ...
                                    <div class="card h-100 p-3 shadow-sm border">
                                        <div class="d-flex align-items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-secondary mt-1 small">Chúng tôi có đội ngũ nhân viên kinh nghiệm...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card h-100 p-3 shadow-sm border">
                                        <div class="d-flex align-items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-secondary mt-1 small">Du khách dễ dàng tìm thấy du thuyền sang trọng...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card h-100 p-3 shadow-sm border">
                                        <div class="d-flex align-items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-secondary mt-1 small">Tour Travel luôn cam kết đem đến dịch vụ chất lượng...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card h-100 p-3 shadow-sm border">
                                        <div class="d-flex align-items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-secondary mt-1 small">Chúng tôi cam kết giữ bí mật tuyệt đối thông tin khách hàng.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="accordion-item shadow-sm mb-3 border rounded-3">
                    <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed fw-bold fs-5 text-primary py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            Điều khoản & Điều kiện
                        </button>
                    </h2>
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#introductionAccordion">
                        <div class="accordion-body bg-light">
                            <h5 class="fw-bold text-dark">Quy định chung</h5>
                            <p>Tất cả các dịch vụ đặt tour đều tuân theo các điều khoản và điều kiện được Tour Travel công bố.</p>
                ...
                <div class="accordion-item shadow-sm mb-3 border rounded-3">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed fw-bold fs-5 text-primary py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            Chính sách quyền riêng tư
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#introductionAccordion">
                        <div class="accordion-body bg-light">
                ...
                <div class="accordion-item shadow-sm mb-3 border rounded-3">
                    <h2 class="accordion-header" id="headingFour">
                        <button class="accordion-button collapsed fw-bold fs-5 text-primary py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            Liên hệ & Thông tin Công ty
                        </button>
                    </h2>
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#introductionAccordion">
                        <div class="accordion-body bg-light">
                            <h4 class="fw-bold text-lg uppercase">Công ty TNHH Du Lịch và Dịch Vụ Tour Travel</h4>
                            <p class="text-sm text-secondary">Tour Travel and Service Company Limited</p>
                            <p class="text-secondary mt-2"><i class="bi bi-geo-alt-fill me-2 text-info"></i>Địa chỉ: Số 25 - Ngõ 38 Phố Yên Lãng – Quận Đống Đa – Hà Nội</p>
                            <p class="text-secondary"><i class="bi bi-telephone-fill me-2 text-info"></i>Điện thoại: 0922222016</p>
                            <p class="text-secondary"><i class="bi bi-envelope-fill me-2 text-info"></i>Email: elitebooking.tour@gmail.com</p>
                        </div>
                    </div>
                </div>
