    ...
    <section class="hero-section">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-6 col-md-12 hero-left text-white z-2">
                    <h1 class="display-4 fw-bolder mb-3">Du lịch cùng Tour Travel</h1>
                    <p class="fs-5 mb-4 opacity-75">Với nguồn lực dồi dào, kinh nghiệm và uy tín trong lĩnh vực dịch vụ du lịch, lữ hành Tour Travel luôn mang đến cho khách hàng những dịch vụ du lịch giá trị nhất.</p>
                ...
                <div class="col-lg-6 d-none d-lg-block text-end hero-right z-1">
                    <img src="<?= BASE_URL . 'assets/image/logo.png' ?>" alt="Tour Travel" class="img-fluid w-100 banner-img">
                </div>
            </div>
        </div>
       ...
       <div class="row justify-content-center search-bar-row position-absolute w-100 start-0" style="bottom: -40px;">
        <div class="col-lg-8 col-md-10 search-popover-wrapper"> 
            ...
            <div class="search-suggestions-box bg-white p-4 shadow-lg rounded-3 border mt-2" style="display: none;" id="searchSuggestions">
                <div class="row">
                    <div class="col-md-6 border-end">
                        ...
                        <a href="#" class="d-flex align-items-center text-decoration-none text-dark mb-3 hover-effect">
                            <img src="<?= BASE_URL . 'assets/image/nhatrang.png' ?>" class="rounded me-3" style="width: 50px; height: 50px; object-fit: cover;">
                            <div>
                                <p class="mb-0 fw-bold small">Nha Trang - Bãi Rêu Tiên - Chùa Long Sơn</p>
                                <p class="mb-0 text-muted small">Tour 3 ngày | Chỉ từ <span class="text-danger fw-bold">6.990.000 đ</span></p>
                            </div>
                        </a>
                        <a href="#" class="d-flex align-items-center text-decoration-none text-dark mb-3 hover-effect">
                            <img src="<?= BASE_URL . 'assets/image/nb.png' ?>" class="rounded me-3" style="width: 50px; height: 50px; object-fit: cover;">
                            <div>
                                <p class="mb-0 fw-bold small">Tour Ninh Bình 2N1Đ - Tràng An, Tam Cốc</p>
                                <p class="mb-0 text-muted small">Tour 2 ngày | Chỉ từ <span class="text-danger fw-bold">2.500.000 đ</span></p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="#" class="d-flex align-items-center text-decoration-none text-dark mb-3 hover-effect">
                            <img src="<?= BASE_URL . 'assets/image/hl.png' ?>" class="rounded me-3" style="width: 50px; height: 50px; object-fit: cover;">
                            <div>
                                <p class="mb-0 fw-bold small">Tour Hà Nội - Côn Đảo - Hạ Long</p>
                                <p class="mb-0 text-muted small">Tour 4 ngày | Chỉ từ <span class="text-danger fw-bold">8.195.000 đ</span></p>
                            </div>
                        </a>
                        <a href="#" class="d-flex align-items-center text-decoration-none text-dark mb-3 hover-effect">
                            <img src="<?= BASE_URL . 'assets/image/tb.png' ?>" class="rounded me-3" style="width: 50px; height: 50px; object-fit: cover;">
                            <div>
                                <p class="mb-0 fw-bold small">Tour Sapa - Tây Bắc 4 ngày 3 đêm</p>
                                <p class="mb-0 text-muted small">Tour 4 ngày | Chỉ từ <span class="text-danger fw-bold">7.650.000 đ</span></p>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <h2 class="display-6 fw-bold text-info mb-4">Công ty cổ phần <span class="text-primary">Tour Travel</span></h2>
                    
                    <p class="text-muted mb-4">
                        Chúng tôi luôn lắng nghe và chia sẻ mong muốn của từng khách hàng, mang lại sự hài lòng về dịch vụ cũng như thái độ phục vụ...
                    </p>
                ...
                <div class="about-images-stack-3">
                    <img src="<?= BASE_URL . 'assets/image/halong.png' ?>" class="img-fluid img-stack-3-behind" alt="Hạ Long">
                    <img src="<?= BASE_URL . 'assets/image/hoguom.png' ?>" class="img-fluid img-stack-3-middle" alt="Hồ Gươm">
                    <img src="<?= BASE_URL . 'assets/image/baibien.png' ?>" class="img-fluid img-stack-3-front" alt="Phú Quốc">
                </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100 p-3 feature-card bg-light-subtle">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted small">Luôn cập nhật các thông tin mới nhất, đầy đủ nhất về các tour tốt nhất hiện nay.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100 p-3 feature-card bg-light-subtle">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted small">Các tư vấn viên chuyên nghiệp luôn sẵn sàng hỗ trợ bạn tận tâm và chi tiết nhất.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100 p-3 feature-card bg-light-subtle">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted small">Các chương trình khuyến mãi hấp dẫn và giá tour cạnh tranh được cập nhật liên tục.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="fs-5 text-muted">
                        Tận hưởng sự xa hoa và đẳng cấp tối đa trên du thuyền mới nhất và phố biến nhất. Khám phá mọi hành trình tuyệt vời đưa bạn vào thế giới của sự sang trọng, nghỉ ngơi và trải nghiệm không thể quên.
                    </p>
                </div>
            </div>

            <div id="destinationCarousel" class="carousel slide carousel-multi-item" data-bs-ride="carousel" data-bs-interval="3000">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row g-4 justify-content-center">
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/hgg.jpg' ?>" alt="Hà Nội Cổ Kính" class="img-fluid destination-img">
                                    
                                    <div class="card-hover-content">
                                        <h5 class="fw-bold mb-1">Du Lịch Văn Hóa Hà Nội 3N2Đ</h5>
                                        <p class="small opacity-75">Tham quan Hồ Gươm, Lăng Bác, Văn Miếu Quốc Tử Giám.</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/lbb.png' ?>" alt="Lăng Bác - Quảng Trường" class="img-fluid destination-img">
                                    
                                    <div class="card-hover-content">
                                        <h5 class="fw-bold mb-1">Tham Quan Quảng Trường Ba Đình</h5>
                                        <p class="small opacity-75">Viếng Lăng Chủ Tịch, khám phá Khu di tích Phủ Chủ Tịch.</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/dn.png' ?>" alt="Tour Đà Nẵng Team Building" class="img-fluid destination-img">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/baibien.png' ?>" alt="Biển Nha Trang" class="img-fluid destination-img">
                    ...
                    <div class="carousel-item">
                        <div class="row g-4 justify-content-center">
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/mc.jpg' ?>" alt="Mộc Châu Mùa Hoa" class="img-fluid destination-img">
                                    
                                    <div class="card-hover-content">
                                        <h5 class="fw-bold mb-1">Mộc Châu - Mùa Hoa Cải</h5>
                                        <p class="small opacity-75">Tour Tây Bắc 4 ngày 3 đêm, trải nghiệm du lịch nông trại.</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/hll.jpg' ?>" alt="Vịnh Hạ Long" class="img-fluid destination-img">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/cm.jpg' ?>" alt="Cam Ranh" class="img-fluid destination-img">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    <img src="<?= BASE_URL . 'assets/image/qnn.png' ?>" alt="Vịnh Hạ Long" class="img-fluid destination-img">
        ...
        <div class="container pt-5">
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="fs-5 text-muted">
                        Khám phá những điểm đến tuyệt vời trong và ngoài nước với các gói tour được thiết kế hoàn hảo mang đến những trải nghiệm du lịch đáng nhớ và giá trị tốt nhất
                    </p>
                </div>
            </div>
                        ...
                        <div class="row g-4 justify-content-start flex-nowrap mx-0"> 
                            ...
                            <div class="col-lg-3 col-md-6 marquee-item">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
                                    ...
                                    <div class="card-overlay"><a href="#" class="stretched-link" title="Xem chi tiết tour"></a></div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 marquee-item">
                                <div class="destination-card position-relative overflow-hidden rounded-3 shadow-lg">
