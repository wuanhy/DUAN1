            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <div class="input-group mb-3 shadow-sm rounded-pill overflow-hidden">
                        <input type="text" class="form-control border-0 py-2 ps-4" placeholder="Nhập tên địa điểm" aria-label="Nhập tên địa điểm">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/nhatrang.png" class="card-img-top" alt="Nha Trang" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 3 ngày 2 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Nha Trang - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/nb.png" class="card-img-top" alt="Ninh Bình" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 2 ngày 1 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Ninh Bình - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/qn.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 4 ngày 3 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Quy Nhơn - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/halong.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 5 ngày 4 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Hà Nội - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/tb.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 4 ngày 3 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Sapa - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/tutinh.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 4 ngày 3 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Bến Tre - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/catba.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 3 ngày 2 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Cát Bà - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/taybac.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 5 ngày 5 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Sapa - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/camranh.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/danang.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 4 ngày 3 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Đà Nẵng - Việt Nam</p>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/ch.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="assets/image/pq.png" class="card-img-top" alt="Quy Nhơn" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 3 ngày 2 đêm</p>
                            <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Phú Quốc - Việt Nam</p>
