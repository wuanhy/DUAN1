        ...
        <section class="tour-cards py-5">
            <div class="container py-5">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/nb.jpg" class="card-img-top" alt="Ninh Bình"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/qn.jpg" class="card-img-top" alt="Quy Nhơn"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/hl.jpg" class="card-img-top" alt="Quy Nhơn"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/tb.jpg" class="card-img-top" alt="Quy Nhơn"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/cb.jpg" class="card-img-top" alt="Quy Nhơn"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/cnt.jpg" class="card-img-top" alt="Cáp Nhĩ Tân"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                                <h5 class="card-title fw-bold">Tour Cáp Nhĩ Tân - Trung Quốc</h5>
                                <p class="text-muted small mb-1">Mã tour: TT031</p>

                                <div class="d-flex align-items-baseline mb-2">
                                    <span class="text-danger fs-4 fw-bolder">77.980.000₫</span>
                                </div>

                                <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 5 ngày
                                    4 đêm</p>
                                <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Cáp Nhĩ Tân - Trung Quốc</p>
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/pr.jpg" class="card-img-top" alt="Paris"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                                <h5 class="card-title fw-bold">Tour Paris – Pháp 5 ngày 4 đêm </h5>
                                <p class="text-muted small mb-1">Mã tour: TT048</p>

                                <div class="d-flex align-items-baseline mb-2">
                                    <span class="text-danger fs-4 fw-bolder">98.980.000₫</span>
                                </div>

                                <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 5 ngày
                                    4 đêm</p>
                                <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Paris - Pháp</p>
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/hq.jpg" class="card-img-top" alt="Seoul"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                                <h5 class="card-title fw-bold">Tour Hàn Quốc 5 ngày 4 đêm</h5>
                                <p class="text-muted small mb-1">Mã tour: TT050</p>

                                <div class="d-flex align-items-baseline mb-2">
                                    <span class="text-danger fs-4 fw-bolder">64.980.000₫</span>
                                </div>

                                <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 5 ngày
                                    4 đêm</p>
                                <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Seoul
                                     - Hàn Quốc</p>
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0">
                            <img src="public/image/bk.jpg" class="card-img-top" alt="Bắc Kinh"
                                style="height: 200px; object-fit: cover;">
                            <div class="card-body p-3">
                                <h5 class="card-title fw-bold">Tour Bắc Kinh - Trung Quốc 5 ngày 4 đêm</h5>
                                <p class="text-muted small mb-1">Mã tour: TT027</p>

                                <div class="d-flex align-items-baseline mb-2">
                                    <span class="text-danger fs-4 fw-bolder">79.980.000₫</span>
                                </div>

                                <p class="card-text mb-1"><i class="bi bi-clock me-2 text-primary"></i>Thời gian: 5 ngày
                                    4 đêm</p>
                                <p class="card-text mb-3"><i class="bi bi-geo-alt me-2 text-primary"></i>Địa điểm: Bắc Kinh - Trung Quốc</p>
